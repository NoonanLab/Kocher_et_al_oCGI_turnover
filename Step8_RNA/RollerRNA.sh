...
##### Convert oCGIs into bed files with names specifying their species-specificity
...
/home/ak2267/project/Roller/RNA/221121_RNA/permutation
...
dsq --job-file 230212_RNA_resamplingTest_jobFile.txt --mem-per-cpu 5G -c 1 --mail-type FAIL,END --max-jobs 100
sbatch dsq-230212_RNA_resamplingTest_jobFile-2023-02-12.sh # 21100275
sbatch dsq-230212_RNA_resamplingTest_jobFile-2023-03-09.sh # 21678311
...
do
    ...
    do
        for mark in H3K4me3 H3K27ac H3K4me1
        do
            python3 summarizeRNAresampling.py ${speciesPair} ${tissue} ${mark}
