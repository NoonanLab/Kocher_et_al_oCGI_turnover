...
# FILES TO USE:
human_permissive_enhancers_phase_1_and_2_hg38.bed
TSS_human_hg38.bed
mouse_permissive_enhancers_phase_1_and_2_mm39.bed
TSS_mouse_mm39.bed

# Promoter data (human and mouse)
# https://fantom.gsc.riken.jp/5/datafiles/phase1.3/extra/TSS_classifier/

# these are all in hg19
wget https://fantom.gsc.riken.jp/5/datafiles/latest/extra/CAGE_peaks/hg19.cage_peak_phase1and2combined_ann.txt.gz
wget https://fantom.gsc.riken.jp/5/datafiles/latest/extra/Enhancers/human_permissive_enhancers_phase_1_and_2.bed.gz
wget https://fantom.gsc.riken.jp/5/datafiles/phase1.3/extra/TSS_classifier/TSS_human.bed.gz
gunzip *.gz

# lift to hg38
liftOver human_permissive_enhancers_phase_1_and_2.bed ~/genomes/chain/hg19ToHg38.over.chain.gz human_permissive_enhancers_phase_1_and_2_hg38.bed unMapped
...
# these are all in mm9
wget https://fantom.gsc.riken.jp/5/datafiles/latest/extra/Enhancers/mouse_permissive_enhancers_phase_1_and_2.bed.gz
wget https://fantom.gsc.riken.jp/5/datafiles/phase1.3/extra/TSS_classifier/TSS_mouse.bed.gz
gunzip *.gz

# lift to mm39
liftOver mouse_permissive_enhancers_phase_1_and_2.bed ~/genomes/chain/mm9ToMm10.over.chain.gz mouse_permissive_enhancers_phase_1_and_2_mm10.bed unMapped
liftOver mouse_permissive_enhancers_phase_1_and_2_mm10.bed ~/genomes/chain/mm10ToMm39.over.chain.gz mouse_permissive_enhancers_phase_1_and_2_mm39.bed unMapped
