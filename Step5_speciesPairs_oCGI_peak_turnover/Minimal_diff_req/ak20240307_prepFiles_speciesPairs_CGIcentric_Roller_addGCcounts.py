...
# Modified 3/7/24 to use new version of countFinalOverlaps script incorporating C and G counts
# and writing to Roller_summaryFiles_addGCcounts/
...
for speciesCombo in SpeciesCombos:
    for tissue in Tissues:
        for mark in Marks:
            ...
            outputString.append('mkdir Roller_'+speciesCombo+'_'+tissue+'_'+mark+'_addGCcounts ; cd Roller_'+speciesCombo+'_'+tissue+'_'+mark +'_addGCcounts')
            ...
            if speciesA == 'mm39':
            	featuresArrayA.append(pathToFANTOM+'FANTOM_TSS_'+speciesA+'.bed')
            	featuresArrayA.append(pathToBlacklist+'blacklist_'+speciesA+'.bed')
            if speciesB == 'mm39':
            	featuresArrayB.append(pathToFANTOM+'FANTOM_TSS_'+speciesB+'.bed')
            	featuresArrayB.append(pathToBlacklist+'blacklist_'+speciesB+'.bed')
            ...
            outputString.append('python /gpfs/gibbs/pi/noonan/ak2267/speciesPairs/Scripts/ak20240307_countFinalOverlaps_speciesPairs_CGIcentric_addGCcounts.py '+' '.join(pythonInputFiles)+' >> '+workingDir+'/Roller_summaryFiles_addGCcounts/'+speciesCombo+'_'+tissue+'_'+mark+'.txt')
