...
# python prepFiles_speciesPairs_CGIcentric_Roller.py /gpfs/gibbs/pi/noonan/ak2267/Roller/peaks/repsToUseRoller.txt repeatFilter > 220915_speciesPairs_CGIcentric_Roller_jobFile.txt
...
for speciesCombo in SpeciesCombos:
    for tissue in Tissues:
        for mark in Marks:
            ...
            # intersect each reconciled list with CGI files to get CGI info within python script - edit 3/3/23 to have ending _CGIsAL_preMerge.bed
            # then: {speciesA}_{speciesB}/{speciesA}_{speciesB}_speciesA_reconciledCGI.bed
            ...
            outputString.append('python /gpfs/gibbs/pi/noonan/ak2267/speciesPairs/Scripts/countFinalOverlaps_speciesPairs_CGIcentric.py '+' '.join(pythonInputFiles)+' >> '+workingDir+'/Roller_summaryFiles/'+speciesCombo+'_'+tissue+'_'+mark+'.txt')
