...
do
    echo 'cd /gpfs/gibbs/pi/noonan/ak2267/speciesPairs/peakCentric/permutation ; source ~/.bashrc ; source ~/.bash_profile ; module load R ; Rscript speciesPairs_permutation_HPC_peakCentric.R '${summaryFile}
