...
####### pairwise comparison with CGIs
cd /home/ak2267/project/CTCF/batch

python prepFiles_speciesPairs_CTCF.py > 220621_speciesPairs_CTCF_jobFile.txt
dsq --job-file 220621_speciesPairs_CTCF_jobFile.txt --mem-per-cpu 5G -c 1 --mail-type FAIL,END --job-name CTCF
sbatch dsq-220621_speciesPairs_CTCF_jobFile-2022-06-21.sh # 15519147

tar -zcvf speciesPairs_CTCF.gz speciesPairs_CTCF
cd /Users/acadiak/Desktop/CGI/CTCF/
scp ak2267@ruddle.hpc.yale.edu:/home/ak2267/project/CTCF/speciesPairs/speciesPairs_CTCF.gz .
